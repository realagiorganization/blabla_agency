...
- Keep the README, Markdown site, and Beamer presentation aligned when claims, scope, or deliverables change.
...
- Prefer repository-provided `Makefile` targets and GitHub Actions workflows over ad-hoc commands once they exist.
